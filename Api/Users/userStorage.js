...
const getPackage = id => {
  const query = `SELECT A.client_id, A.package_id, A.tracking, A.weight, A.ing_date, A.ent_date, A.total_a_pagar, A.anticipo, A.entregado, A.status, A.guide, A.master, A.poliza
                FROM paquetes A
